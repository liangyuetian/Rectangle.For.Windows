...
> 偏好设置窗口有意保持简洁，但许多选项可通过终端修改。执行命令后需**重启应用**才能生效。Rectangle Pro 请将 `com.knollsoft.Rectangle` 替换为 `com.knollsoft.Hookshot`。配置快捷键时需使用键码和修饰键整数值，可使用 [Key Codes](https://apps.apple.com/us/app/key-codes/id414568915) 等应用查看。
