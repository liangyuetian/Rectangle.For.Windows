...
namespace Rectangle.Windows.WinUI.Services
{
    ...
    public class ScreenDetectionService
    {
        ...
        public List<Core.WindowRect> GetAllWorkAreas()
        {
            ...
            unsafe
            {
                PInvoke.EnumDisplayMonitors(new HDC(0), null, (hMonitor, hdcMonitor, lprcMonitor, dwData) =>
                {
        ...
        /// <summary>
        /// 获取所有显示器工作区（GetAllWorkAreas 的别名，供 EdgeIndicatorService 使用）
        /// </summary>
        public List<Core.WindowRect> GetAllScreens() => GetAllWorkAreas();
