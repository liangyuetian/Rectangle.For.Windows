    ...
    public class ConfigService
    {
        ...
        public static Dictionary<string, ShortcutConfig> GetDefaultShortcuts()
        {
            ...
            return new Dictionary<string, ShortcutConfig>
            {
                ...
                ["CenterHalf"]        = new() { KeyCode = 0x48, ModifierFlags = ctrlAltWin },
                ...
                ["AlmostMaximize"]    = new() { KeyCode = 0x4D, ModifierFlags = ctrlAltWin },
                ...
                ["FirstFourth"]       = new() { KeyCode = 0x31, ModifierFlags = ctrlAltWin },
                ["SecondFourth"]      = new() { KeyCode = 0x32, ModifierFlags = ctrlAltWin },
                ["ThirdFourth"]       = new() { KeyCode = 0x33, ModifierFlags = ctrlAltWin },
                ["LastFourth"]        = new() { KeyCode = 0x34, ModifierFlags = ctrlAltWin },
                ...
                ["MoveLeft"]          = new() { KeyCode = 0x4A, ModifierFlags = ctrlAltWin },
                ["MoveRight"]         = new() { KeyCode = 0x4C, ModifierFlags = ctrlAltWin },
                ["MoveUp"]            = new() { KeyCode = 0x49, ModifierFlags = ctrlAltWin },
                ["MoveDown"]          = new() { KeyCode = 0x4B, ModifierFlags = ctrlAltWin },
